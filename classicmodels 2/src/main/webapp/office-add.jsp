...
<div class="container">
    <div class="header">
        <h1 class="col-8">Add New Office ::</h1>
    </div>
    <div class="row">
        ...
        <div class="col-2 mt-2">
            <form action="office-add" method="get" class="pr-2">
                <input type="submit" class="btn btn-custom" value="ADD-OFFICE">
            </form>
        </div>
        <div class="col-8"></div>
    </div>
    <form action="office-add" method="post">
        <div class="form-row">
            <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control form-control-lg" id="offCode" name="offCode" required>
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control form-control-lg" id="address1" rows="3" name="addressLine1" required></textarea>
            </div>
            <div class="form-group col-md-6">
                <label for="address2" class="ml-2">Address Line2:</label>
                <textarea class="form-control form-control-lg" id="address2" rows="3" name="addressLine1" ></textarea>
            </div>
            <div class="form-group col-md-3">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control form-control-lg" id="postalCode" name="postalCode" required>
            </div>
            <div class="form-group col-md-3">
        ...
        <br>
        <div class="right">
            <input class="btn btn-success" type="submit" value="ADD NEW OFFICE">
        </div>
    </form>
    <br>
